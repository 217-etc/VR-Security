...
{
    [RequireComponent(typeof(MeshFilter)), RequireComponent(typeof(MeshRenderer)), RequireComponent(typeof(ERope))]
    public class ERopeMesh : MonoBehaviour
    {
        [Range(3, 25)] public int OverallDivision = 25;
        [Range(0.01f, 10)] public float ropeWidth = 0.07f;
        ...
        public void CreateRopeMesh(Vector3[] points, float radius, int segmentsPerWire)
        {
            ...
            if (ropeMesh == null)
            {
                ropeMesh = new Mesh { name = "ERopeMesh" };
